...
import CategoryEditModalComponent from '@/Components/Backend/Category/CategoryEditModalComponent.vue';
...
import TableSkeleton from '@/Components/Backend/TableSkeleton.vue';
    ...
    onMounted(()=> CategoryStore.itemList())
...
<template>
    ...
    <MasterLayout>
        ...
        <div class="space-y-6 h-auto mt-3 card">
            <div class="w-full space-y-5 card-body" v-if="!CategoryStore.skeletonIsActive">
                ...
                >
                    ...
                    <template #item-action="{id}">
                        <div class="flex gap-3 items-center">
                            <button @click="CategoryStore.edit(id)" class="p-1.5 text-[14px] text-green-500 border border-green-500 rounded-md duration-200 hover:bg-[#6FD943] hover:text-white">
                                <EditIcon/>
                            </button>

                            <button @click="CategoryStore.destroy(id)" class="p-1.5 text-[15px] text-red-500 border border-red-400 rounded-md duration-200 hover:bg-red-400 hover:text-white">
                                <DeleteIcon/>
                            </button>
                        </div>
                    </template>
